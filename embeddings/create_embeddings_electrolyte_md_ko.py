...
def main():
    data_path = "docx_ko/Electrolyte disorders"  # 전해질 이상 요약문서 경로
    vector_store_path = "vector_store_electrolyte_ko"
    ...
    print(f"✅ Electrolyte Disorders 벡터 저장 완료: {vector_store_path}")
